...
public class Level3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_level3_);
        Toast.makeText(getApplicationContext(), "Congrats, you've made it to level 3", Toast.LENGTH_LONG).show();
        ...
        int qidValue = dificultyData.getInt("qid2");
        if(qidValue == 15)
        {
            qid = 15;
        }
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ2.getANSWER().equals(AnswerString)) {
            ...
            if (score == 9) {
                ...
                Intent i = new Intent(this, Finish_Activity.class);
                startActivity(i);
            }
